...
class Quote {
  ...
  factory Quote.fromMap(Map<String, dynamic> json) => new Quote(
    ...
    tags: DataConverter.stringToIntegerList(json[DataContract.QUOTES_COLUMN_NAME_TAG_IDS]),
  ...
  Map<String, dynamic> toMap() => {
    ...
    DataContract.QUOTES_COLUMN_NAME_TAG_IDS: DataConverter.getStringFromIntegerList(tags),
  ...
  static Quote createQuote(int id, String author, String origin, String body, String comment, List<int> tags) {
    Quote set = new Quote();
  ...
  static Quote createQuoteAdvanced(int id, String author, String origin, String quote, String comment, bool private, List<int> tags, DateTime dateCreated, DateTime lastEdited, bool deleted, DateTime dateDeleted) {
